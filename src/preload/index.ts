...
const api: Api = {
  ...
  checkoutGitBranch: (cwd, branch) => ipcRenderer.invoke("checkoutGitBranch", cwd, branch),
  ...
  respondToUiRequest: (k, response) => ipcRenderer.invoke("respondToUiRequest", k, response),
  ...
  getMetricsSummary: (filter) => ipcRenderer.invoke("getMetricsSummary", filter),
  refreshMetricsBackfill: (filter) => ipcRenderer.invoke("refreshMetricsBackfill", filter),
  ...
  updateAdvisorConfig: (partial) => ipcRenderer.invoke("updateAdvisorConfig", partial),
  getSystemPrompt: () => ipcRenderer.invoke("getSystemPrompt"),
  updateSystemPrompt: (systemPrompt) => ipcRenderer.invoke("updateSystemPrompt", systemPrompt),
